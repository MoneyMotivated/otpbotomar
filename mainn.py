...
def how_to_help(message):
    bot.send_message(message.chat.id, "• Contact @MADARA888UCHIHA or @MADARA888UCHIHA 👑\n\n• Use /faq for more help")


@bot.message_handler(commands=['faq'])
def how_faq(message):
    bot.send_message(message.chat.id, "• Please use @MADARA888UCHIHA for tutorial videos, and more helpful information (FAQ > Bot Help). \n\n• Send vouches to @MADARA888UCHIHA\n\n•")
